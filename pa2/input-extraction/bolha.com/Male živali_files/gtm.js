...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_measurementId":"G-H9M3NJEC3L",
      ...
      "vtp_uniqueTriggerId":"12909597_47",
  ...
  "rules":[
    ...
    [["if",4,16],["add",17]],
    [["if",4,17],["add",17]],
    [["if",18,19],["add",18],["block",19,20,21]],
    [["if",20,21],["add",21]]]
},
"runtime":[]
...
var Pd=[C.B,C.I],Qd=function(a){var b=a[C.Qd];b&&E(40);var c=a[C.Rd];c&&E(41);for(var d=Fa(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==C.Qd&&f!==C.Rd)if(-1<Ga(Pd,f)){var h=f,k=a[f],l=d[e];Ad().set(h,k,l,"SI","",c)}else{}},Rd=function(a,b){for(var c in a)if(a.hasOwnProperty(c))if(-1<
